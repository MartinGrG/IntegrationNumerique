...
def tracer_tps_calcul_rectangles():
    rect_base_tps = compare(methode_rectangle_python, methode_rectangle_numpy, coef, a, b)[0, 0, :]
    rect_numpy_tps = compare(methode_rectangle_python, methode_rectangle_numpy, coef, a, b)[1, 0, :]
...
def tracer_tps_calcul_trapezes():
    trap_base_tps = compare(methode_trapezes_python, methode_trapezes_numpy, coef, a, b)[0, 0, :]
    trap_numpy_tps = compare(methode_trapezes_python, methode_trapezes_numpy, coef, a, b)[1, 0, :]
    trap_existante_tps = compare(methode_trapezes_existante, methode_trapezes_numpy, coef, a, b)[0, 0, :]
    ...
    plt.title('TRAPÈZESTracé du temps de calcul en fonction du nombre de segments')
    plt.xlabel('Nombre de segments')
    plt.ylabel('Temps de calcul')
    plt.legend()
    # Affichage du graphique
...
def tracer_tps_calcul_simpson():
    simp_base_tps = compare(methode_simpson_python, methode_simpson_numpy, coef, a, b)[0, 0, :]
    simp_numpy_tps = compare(methode_simpson_python, methode_simpson_numpy, coef, a, b)[1, 0, :]
    simp_existante_tps = compare(methode_simpson_existante, methode_simpson_numpy, coef, a, b)[0, 0, :]
...
def tracer_err_rectangle():
    rect_base_err= compare(methode_rectangle_python, methode_rectangle_numpy, coef, a, b)[0, 2, :]
    rect_numpy_err = compare(methode_rectangle_python, methode_rectangle_numpy, coef, a, b)[1, 2, :]
...
def tracer_err_trapeze():
    trap_base_err = compare(methode_trapezes_python, methode_trapezes_numpy, coef, a, b)[0, 2, :]
    trap_numpy_err = compare(methode_trapezes_python, methode_trapezes_numpy, coef, a, b)[1, 2, :]
    trap_existante_err = compare(methode_trapezes_existante, methode_trapezes_numpy, coef, a, b)[0, 2, :]
...
def tracer_err_simpson():
    simp_base_err = compare(methode_simpson_python, methode_simpson_numpy, coef, a, b)[0, 2, :]
    simp_numpy_err = compare(methode_simpson_python, methode_simpson_numpy, coef, a, b)[1, 2, :]
    simp_existante_err = compare(methode_simpson_existante, methode_simpson_numpy, coef, a, b)[0, 2, :]
